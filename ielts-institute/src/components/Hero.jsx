        ...
        <div className="grid items-center gap-10 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-8 flex items-center gap-3">
              <a href="#features" className="inline-flex items-center rounded-md bg-primary-600 px-5 py-3 text-white hover:bg-primary-700">
                View Courses
              </a>
          ...
          <div className="relative">
            <img
              src="https://images.unsplash.com/photo-1434030216411-0b793f4b4173?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8ZXhhbXN8ZW58MHx8MHx8fDA%3D"
              alt="Student studying for exams"
              className="aspect-[4/3] w-full rounded-2xl object-cover shadow-sm ring-1 ring-black/5"
            />
          </div>
        </div>
      </Container>
